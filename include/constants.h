...
#define COBFS4_SERVER_HANDSHAKE_LEN (COBFS4_ELLIGATOR_LEN + COBFS4_AUTH_LEN + COBFS4_HMAC_LEN + COBFS4_HMAC_LEN + COBFS4_INLINE_SEED_FRAME_LEN)
#define COBFS4_SERVER_MIN_PAD_LEN (0)
#define COBFS4_SERVER_MAX_PAD_LEN (COBFS4_MAX_HANDSHAKE_SIZE - COBFS4_SERVER_HANDSHAKE_LEN)

#define COBFS4_SERVER_TIMING_SEED_LEN (COBFS4_SECRET_KEY_LEN)

#define COBFS4_CLIENT_HANDSHAKE_LEN (COBFS4_ELLIGATOR_LEN + COBFS4_HMAC_LEN + COBFS4_HMAC_LEN)
